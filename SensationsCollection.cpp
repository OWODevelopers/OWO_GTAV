...
const string SensationsCollection::Heavy = "11~Heavy~100,10,65,0,1000,0,|5%100,4%100,0%100~weapon-0~Recoil";
const string SensationsCollection::Melee = "1~Melee~100,3,90,0,200,0,~impact-2~Impacts";
const string SensationsCollection::Pistol = "8~Pistol~55,1,35,0,100,0,Recoil|4%100,5%100~weapon-2~Recoil";
const string SensationsCollection::Shoot = "12~Shoot~10,1,30,0,0,0,|5%100,4%100~weapon-2~Recoil";
const string SensationsCollection::Shotgun = "10~Shotgun~100,1,60,0,0,0,|5%100,4%100,0%100&57,3,55,0,300,0,|4%100,5%100,0%100~weapon-0~Recoil";
...
const string SensationsCollection::Assault = "13~Assault~50,1,40,0,0,2,|0%100,5%100,4%100~weapon-3~Recoil";
const string SensationsCollection::Launcher = "14~Launcher~100,2,50,0,100,0,|5%100,4%100,1%100,0%100&100,3,70,0,300,0,|0%100,5%100,4%100~weapon-2~Recoil";
